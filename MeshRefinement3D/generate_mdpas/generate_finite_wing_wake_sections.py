...
Outlet_Min_Mesh_Size_List = [0.05, 0.05, 0.05, 0.05, 0.05]
Outlet_Max_Mesh_Size_List = [0.10, 0.10, 0.10, 0.10, 0.10]
...
for k in range(Number_Of_AOAS):
    ...
    for j in range(Number_Of_Domains_Refinements):
        ...
        for i in range(Number_Of_Wing_Refinements):
            ...
            # Smallest_Airfoil_Mesh_Size = Smallest_Airfoil_Mesh_Size
            # Growth_Rate_Wing = Growth_Rate_Wing
