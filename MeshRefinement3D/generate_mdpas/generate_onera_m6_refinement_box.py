...
for k in range(Number_Of_AOAS):
    ...
    for j in range(Number_Of_Domains_Refinements):
        ...
        for i in range(Number_Of_Wing_Refinements):
            ...
            NETGEN_2D_1 = Mesh_Domain.Triangle(algo=smeshBuilder.NETGEN_2D,geom=Face_Refinementbox_Outlet_1)
            Sub_mesh_Refinement_Box_Outlet_Surface = NETGEN_2D_1.GetSubMesh()
            NETGEN_2D_Parameters_Refinement_Box_Outlet = NETGEN_2D_1.Parameters()
            ...
            smesh.SetName(Local_Length_Refinement_Box_Outlet_Edges, 'Local_Length_Refinement_Box_Outlet_Edges')
            smesh.SetName(Sub_mesh_Refinement_Box_Outlet_Edges, 'Sub_mesh_Refinement_Box_Outlet_Edges')

            smesh.SetName(NETGEN_2D_1.GetAlgorithm(), 'NETGEN_2D_1')
            smesh.SetName(NETGEN_2D_Parameters_Refinement_Box_Outlet, 'NETGEN_2D_Parameters_Refinement_Box_Outlet')
            ...
            smesh.SetName(NETGEN_2D_2.GetAlgorithm(), 'NETGEN_2D_2')
            smesh.SetName(NETGEN_2D_Parameters_Refinement_Box_Coarse, 'NETGEN_2D_Parameters_Refinement_Box_Coarse')
            smesh.SetName(Sub_mesh_Refinement_Box_Faces_Coarse, 'Sub_mesh_Refinement_Box_Faces_Coarse')
