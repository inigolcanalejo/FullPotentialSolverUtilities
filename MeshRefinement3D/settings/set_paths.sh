...
/$Salome_Converter_File_Path /$Generate_Mesh_File_Path /$Generate_Mesh_Middle_File_Path

sed 's|'"mdpa_path = 'TBD'"'|'"mdpa_path = '$mdpa_path'"'|g' -i \
/$Salome_Converter_File_Path /$Potential_Flow_Analysis_File_Path /$Generate_Mesh_File_Path /$Generate_Mesh_Middle_File_Path
