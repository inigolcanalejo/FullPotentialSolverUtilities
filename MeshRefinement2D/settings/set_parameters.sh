...
Generate_Mesh_Naca0012_File_Path=$PWD/generate_mdpas/generateMeshRefinementNaca0012.py
...
sed 's|'"Number_Of_Refinements = TBD"'|'"Number_Of_Refinements = $Number_Of_Refinements"'|g' -i /$Generate_Mesh_File_Path \
                                /$Salome_Converter_File_Path  /$Generate_Mesh_Cosine_File_Path /$Generate_Mesh_Naca0012_File_Path /$Generate_Mesh_Cosine_Wake_File_Path \
