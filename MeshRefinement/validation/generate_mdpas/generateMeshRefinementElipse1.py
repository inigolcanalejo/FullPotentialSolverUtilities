...
for k in range(Number_Of_Domains_Size):
    ...
    for j in range(Number_Of_AOAS):
        ...
        for i in range(Number_Of_Refinements):
            ...
            Lower_Elipse = geompy.MakeCurveParametric("-0.5*sqrt(1 - ((0.2*t - 0.1)/0.1)**2)", "0.2*t - 0.1", "0", 0, 1, 999, GEOM.Interpolation, True)
            ...
            #geompy.ChangeOrientationShell(Upper_Elipse)
            #ds = geompy.ChangeOrientationShell(Edge_LowerLE)
            ...
            #geompy.UnionList(Body_Sub_mesh, [Edge_UpperSurface_LE,Edge_LowerSurface, Edge_UpperSurface])
            ...
            #Local_Length_2 = Regular_1D.LocalLength(Airfoil_MeshSize,None,1e-07)
