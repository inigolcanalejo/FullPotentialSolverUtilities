...
for k in range(Number_Of_Domains_Size):
    ...
    for j in range(Number_Of_AOAS):
        ...
        for i in range(Number_Of_Refinements):
            ...
            alpha = 0.0
            print('int(number_of_steps*2 + 1) = ', int(number_of_steps*2 + 1))
            for step in range(int(number_of_steps*2 + 1)):
            ...
            # Generate airfoil
            Airfoil = geompy.MakeInterpol(points, True, False)
            # Divide
            ...
            Face_Airfoil = geompy.MakeFaceWires([Airfoil], 1)
