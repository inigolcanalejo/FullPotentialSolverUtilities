...
Generate_Mesh_Cosine2_File_Path=$PWD/generate_mdpas/generateMeshRefinementCosine2.py
...
sed 's|'"Number_Of_Refinements = TBD"'|'"Number_Of_Refinements = $Number_Of_Refinements"'|g' -i /$Generate_Mesh_File_Path \
                                /$Salome_Converter_File_Path /$Mesh_Refinement_File_Path /$Generate_Mesh_Cosine_File_Path /$Generate_Mesh_Cosine2_File_Path /$Generate_Mesh_Elipse1_File_Path \
