...
Wake_Thickness = Far_Field_Mesh_Size*0.05
...
geompy.UnionList(Auto_group_for_Sub_mesh_Far_Field_Surface, [Face_Inlet, Face_Left_Wall, Face_Down_Wall, Face_Top_Wall, Face_Right_Wall, Face_Outlet, Face_Outlet_Wake])
...
# Wake surface
Auto_group_for_Sub_mesh_Wake_Surface = geompy.CreateGroup(Partition_Domain, geompy.ShapeType["FACE"])
geompy.UnionList(Auto_group_for_Sub_mesh_Wake_Surface, [Face_LE_Wake,Face_Left_Wake,Face_Down_Wake,Face_Top_Wake,Face_Right_Wake])

# Wake edges
Auto_group_for_Sub_mesh_Wake_Edges = geompy.CreateGroup(Partition_Domain, geompy.ShapeType["EDGE"])
geompy.UnionList(Auto_group_for_Sub_mesh_Wake_Edges, [Edge_Wake_Left, Edge_Wake_Down, Edge_Wake_Up, Edge_Wake_Right])
...
# LETE edges
Auto_group_for_Sub_mesh_LETE = geompy.CreateGroup(Partition_Domain, geompy.ShapeType["EDGE"])
...
geompy.addToStudyInFather( Partition_Domain, Face_Lower_LE, 'Face_Lower_LE' )
geompy.addToStudyInFather( Partition_Domain, Face_Upper_LE, 'Face_Upper_LE' )
...
geompy.addToStudyInFather( Partition_Domain, Face_Lower_TE, 'Face_Lower_TE' )
...
geompy.addToStudyInFather( Partition_Domain, Auto_group_for_Sub_mesh_LETE, 'Auto_group_for_Sub-mesh_LETE' )
...
# Wake surface
NETGEN_2D_1D = Mesh_Domain.Triangle(algo=smeshBuilder.NETGEN_1D2D,geom=Auto_group_for_Sub_mesh_Wake_Surface)
Sub_mesh_Wake_Surface = NETGEN_2D_1D.GetSubMesh()
NETGEN_2D_Parameters_Wake = NETGEN_2D_1D.Parameters()
NETGEN_2D_Parameters_Wake.SetMaxSize( Wake_Thickness )
NETGEN_2D_Parameters_Wake.SetOptimize( 1 )
NETGEN_2D_Parameters_Wake.SetFineness( 0 )
NETGEN_2D_Parameters_Wake.SetMinSize( Wake_Thickness )
...
NETGEN_2D_Parameters_FarField.SetMinSize( Wake_Thickness )
...
NETGEN_2D_Parameters_Wing.SetSecondOrder( 1 )
...
# Wake-Far field edges
Regular_1D_5 = Mesh_Domain.Segment(geom=Auto_group_for_Sub_mesh_Wake_Edges)
Local_Length_Wake = Regular_1D_5.LocalLength(Wake_Thickness,None,1e-07)
...
smesh.SetName(NETGEN_2D_1D.GetAlgorithm(), 'NETGEN_2D_1D 2D')
...
file_name = "/salome_files/generate_finite_wing_wake.hdf"
